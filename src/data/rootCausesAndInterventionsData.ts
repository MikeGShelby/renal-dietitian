export const rootCausesAndInterventionsData = [
  // MEDICATION-RELATED
  {
  ...
  },
  {
    ...
    intervention: "Encouraged patient to limit fluid intake and attend all dialysis treatments, while following treatment plan for condition.",
    type: "Clinical/Medical",
